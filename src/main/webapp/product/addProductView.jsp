...
<head>
    ...
    <title>Jelly Belly - Add Candy</title>
...
<body>
    ...
    <div class="page-container">
        ...
        <main>
            ...
            <form name="productForm" action="${cPath}/product/addProduct" method="post" enctype="multipart/form-data" class="mt-4">
                ...
                <div class="mb-3">
                    ...
                    <textarea id="prodDetail"   <%-- ID/name 복원! --%>
                              name="prodDetail" 
                              class="form-control" 
                              rows="5"
                              required></textarea>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group" style="max-width: 250px;">
                        <input type="text" 
                               class="form-control"
                               id="manufactureDay"  <%-- ID/name 복원! --%>
                               name="manufactureDay" 
                               readonly="readonly" <%-- readonly 복원! --%>
                               maxLength="10" 
                ...
                <div class="mb-3">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        <label for="imageFile" class="btn btn-subtle mb-0">이미지 선택</label>
                        <span id="imageFileName" class="text-muted">선택된 파일 없음</span>
                    </div>
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <%-- '취소' 버튼 (onclick 이벤트) --%>
                    <button type="button" class="btn btn-subtle" onclick="location.href='${cPath}/product/listProduct'">취소</button>
                </div>
